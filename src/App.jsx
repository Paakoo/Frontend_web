...
const App = () => {
  ...
  const handleSubmitForm = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://192.168.100.22:5000/api/save_user', formData);
      setStep(2);
  ...
  const capturePhoto = async () => {
    ...
    try {
      ...
      //     filename: `${payload.username}_${payload.angle}_${payload.count}.jpg`
      //   }
      // };
      ...
      const response =  await axios.post('http://192.168.100.22:5000/api/save_image', payload)
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
            ...
            <form onSubmit={handleSubmitForm} className="space-y-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="wearsGlasses" className="text-sm font-medium text-gray-700">
